...
$(document).ready(function () {
    // Create cyber loading effect
    const loader = document.getElementById('loader');
    if (loader) {
        const loaderText = loader.querySelector('text');
        if (loaderText) {
            loaderText.style.animation = 'textStroke 3s ease-in-out infinite, textGlow 2s ease-in-out infinite alternate';
        }
    }
...
// Enhanced designer text with cyber theme
firstText = "SOC Analyst";
secondText = "CTF Player";
thridText = "Security Expert";
fourthText = "DFIR Specialist";
fifthText = "Threat Hunter";
intervalTime = 800;
...
function displayText() {
    ...
    designerElement.innerText = firstText;
    designerElement.style.color = '#00ffff';
    
    setTimeout(() => {
        designerElement.innerText = secondText;
        designerElement.style.color = '#00ff88';
    }, intervalTime * 2);
    
    setTimeout(() => {
        designerElement.innerText = thridText;
        designerElement.style.color = '#ff6b6b';
    }, intervalTime * 4);
    
    setTimeout(() => {
        designerElement.innerText = fourthText;
        designerElement.style.color = '#4ecdc4';
    }, intervalTime * 6);
    
    setTimeout(() => {
        designerElement.innerText = fifthText;
        designerElement.style.color = '#ffe66d';
    }, intervalTime * 8);
}
...
// Enhanced cyber security particles
function createSecurityParticles() {
    ...
    setInterval(() => {
        ...
        particle.style.backgroundColor = ['#00ffff', '#00ff88', '#0088ff', '#ff6b6b'][Math.floor(Math.random() * 4)];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add hover effects to skill circles
